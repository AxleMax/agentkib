...
export interface StorageNode { id: string; name: string; relative_path: string; kind: StorageNodeKind; allocated_bytes: number; logical_bytes: number; regenerable_bytes: number; agent_asset_bytes: number; file_count: number; directory_count: number; child_count: number; children: StorageNode[]; expandable: boolean; partial: boolean }
