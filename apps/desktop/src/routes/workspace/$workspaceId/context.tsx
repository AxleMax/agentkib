...
function WorkspaceContextRoute() {
  ...
  return <ContextPage project={project} onOpenInstructions={() => void navigate({ to: "/workspace/$workspaceId/assets", params: { workspaceId }, search: { workspaceAssetSection: "instructions" } as never })} />;
}

export const Route = createFileRoute("/workspace/$workspaceId/context")({ component: WorkspaceContextRoute });
