...
export const api = {
  ...
  workspaceStorageChildren: (workspaceId: string, relativePath: string) => invoke<StorageNode>("get_workspace_storage_children", { workspaceId, relativePath }),
  openWorkspaceStoragePath: (workspaceId: string, relativePath: string) => invoke<void>("open_workspace_storage_path", { workspaceId, relativePath }),
